...
#
-week3_example2:Finding the bigest of 3 numbers(3 sayı arasından en büyüğü bulma)
#
-week3_example3:Writing the numbers from 1 to 5(1 den 5 e kadar olan sayıları yazma)
#
-week3_example4:Sum of numbers from 1 to 5(1 den 5 e kadar olan sayıların toplamı)
#
-h_3h_5h_rule
#
...
#
-week4_example2:Factorial(faktöriyel)
#
-week4_example3:2 numbers are entered from the keyboard print the numbers between the two numbers divisible by 5(klavyeden 2 sayı girilir iki sayı arasındaki 5 ile bölünebilenleri yazdır)
#
-week4_example4:Sum of the digits of the entered number(girilen sayının basamaklarındaki sayının toplamı)
#
-week4_example5:Program to find if the number entered from the keyboard is a prime number(klavyeden girilen sayının asal sayı olup olmadığını bulan program)
#
-all_of_sum:Sum of numbers , odd numbers and even numbers from 1 to n(1'den n'e kadar olan sayıların , tek sayıların ve çift sayıların toplamı)
#
-anti_number:Reverse writing of the entered number(girilen sayının tersten yazımı)
#
-choose_number:Selecting the digit of the number whose numerator and denominator are entered(pay ve paydası girilen sayının basamağını seçme)
#
-combination:Combination(kombinasyon)
#
-f_fonks:Finding out whether y=x²-5x+3 is positive, negative or zero according to the entered x number(girilen x sayısına göre y=x²-5x+3 değerinin pozitif , negatif veya sıfır olduğunu bulma)
#
...
#
-week5_example2:University grade calculation(üniversite not hesaplama)
#
-week5_example3:The program that finds the integer 0<a<100 that satisfies the condition b=a³-a² according to the number of b taken(alınan b sayısına göre b=a³-a² şartını sağlayan 0<a<100 tamsayısını bulan program)
#
-week5_example4:the multiplication table(çarpım tablosu)
#
-week5_example5:take row and column from user and star by number(satır ve sütunu kullanıcıdan alıp sayıya göre yıldız yap)
#
-week5_example6:Increasing stars in each row(her satırda artan yıldızlar)
#
-falling_stars:decreasing star on each line(her satırda azalan yıldız)
#
...
#
-week6_example2:ascending star on each row(her satıda tersten artan yıldız)
#
-week6_example3:making a hollow square with stars(yıldızlarla içi boş kare yapma)
#
-week6_example4:Guess the number between 1 and 100 chosen by the computer(bilgisayarın seçtiği 1 ile 100 arasındaki sayıyı tahmin etme)
#
-arithmetic_number:Program to find if a positive integer entered from the keyboard is an arithmetic number(klavyrden girilen pozitif tamsayının aritmetik sayı olup olmadığını bulan program)
#
-chen_prime:Program to find whether a number entered from the keyboard is a Chen prime or not(klavyeden girilen sayının Chen asalı olup olmadığını bulan program)
#
-friend_number:Program to find if 2 integers entered from the keyboard are friendly numbers(klavyeden girilen 2 tamsayının dost sayılar olup olmadığını bulan program)
#
